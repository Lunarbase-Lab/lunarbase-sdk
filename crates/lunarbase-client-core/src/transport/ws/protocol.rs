...
use crate::model::{ChainCursor, Commitment, ContractFilter};
use crate::transport::rpc::client::RpcError;
use crate::transport::rpc::codec::parse_rpc_head;
use lunarbase_math::types::B256;
use serde_json::{Value, json};

#[derive(Clone, Debug)]
pub(super) struct WsHead {
    pub(super) cursor: ChainCursor,
    pub(super) parent_hash: Option<B256>,
}

pub(super) fn subscription_request(id: u64, filter: &ContractFilter, kind: &str) -> String {
...
pub(super) fn parse_ws_head(value: &Value, chain_id: u64) -> Result<WsHead, RpcError> {
...
pub(super) fn head_discontinuity(previous: &WsHead, next: &WsHead, progressive: bool) -> bool {
