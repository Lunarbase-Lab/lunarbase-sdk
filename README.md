...
All public packages use version 0.4.1.
...
```sh
cargo add lunarbase-pmm-v2-math@0.4.1
cargo add lunarbase-pmm-v2-client@0.4.1
cargo add lunarbase-pmm-v2-source-evm@0.4.1
```

TypeScript:

```sh
pnpm add @lunarbase-lab/pmm-v2-math@0.4.1
pnpm add @lunarbase-lab/pmm-v2-client@0.4.1
pnpm add @lunarbase-lab/pmm-v2-source-evm@0.4.1
```
